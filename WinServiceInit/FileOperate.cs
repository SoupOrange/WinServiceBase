...
namespace Common.Utility
{
    public class FileOperate
    {
        ...
        protected void Write_Txt(string FileName, string Content)
        {
            ...
            string htmlfilename = AppDomain.CurrentDomain.BaseDirectory+ "\\Precious\\" + FileName + ".txt";　//保存文件的路径
            string str = Content;
        ...
        protected string Read_Txt(string filename)
        {
            ...
            Encoding code = Encoding.GetEncoding("gb2312");
            string temp = AppDomain.CurrentDomain.BaseDirectory+"Precious\\" + filename + ".txt";
            string str = "";
            if (File.Exists(temp))
            {
